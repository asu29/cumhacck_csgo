...
unsigned long render::fonts::main_font1;
unsigned long render::fonts::speed_font;
...
void render::initialize() 
{
	...
	interfaces::surface->set_font_glyph(render::fonts::main_font1, "Verdana Bold", 35, 700, 0, 0, font_flags::fontflag_dropshadow);
	...
	interfaces::surface->set_font_glyph(speed_font, "Verdana Bold", 35, 800, 0, 0, font_flags::fontflag_antialias | font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::arrow_font, "Verdana Bold", 20, 700, 0, 0, font_flags::fontflag_outline);
	interfaces::surface->set_font_glyph(render::fonts::watermark_font, "Verdana Bold", 50, 700, 0, 0, font_flags::fontflag_dropshadow);
